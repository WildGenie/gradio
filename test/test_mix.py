...
class TestSeries(unittest.TestCase):
    def test_in_interface(self):
        io1 = gr.Interface(lambda x: f'{x} World', "textbox", gr.outputs.Textbox())
        io2 = gr.Interface(lambda x: f'{x}!', "textbox", gr.outputs.Textbox())
...
class TestParallel(unittest.TestCase):
    def test_in_interface(self):
        io1 = gr.Interface(lambda x: f'{x} World 1!', "textbox", gr.outputs.Textbox())
        io2 = gr.Interface(lambda x: f'{x} World 2!', "textbox", gr.outputs.Textbox())
